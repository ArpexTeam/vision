    ...
    return(
        <div className='bg-black w-full pt-10 h-auto relative'>
            <div className='max-w-[1280px] w-4/5 mr-auto ml-auto h-auto relative'>  
                <div className='items-center justify-center flex flex-col md:flex-row gap-6 sm:gap-16 md:gap-32'>
                        ...
                        <div>
                            <img src={claquete} className='w-[130px] sm:w-[260px] ml-auto'/>
                        </div>
                        </div>
                        
                <div className="gap-6 sm:gap-12 mt-3 sm:mt-20 flex md:flex-row flex-col w-full text-white text-left ml-auto mr-auto">
                    <div className="mt-8 w-full md:w-6/12 xl:w-5/12 md:text-left text-center bg-gradient-to-l md:pl-6 pb-0 sm:pb-16 md:px-10 rounded-xl">
                ...
                <div className="gap-6 sm:gap-12 mt-8 sm:mt-20 flex md:flex-row flex-col w-full text-white text-left ml-auto mr-auto">
                ...
                <iframe className="w-full h-full object-cover rounded-lg"
                    ...
                    <div className="mt-8 order-1 md:order-2 w-full md:text-left text-center md:w-5/12 bg-gradient-to-l md:pl-6 sm:pb-16 md:px-10 rounded-xl">
                    <h2 className="font-[ClashDisplay-Semibold] text-[28px] md:text-[36px]/10 titleBlueLine mb-4 sm:mb-8">
                    {t("events.title_cattolica")}
                    </h2>
                        <p className='sm:mt-10 font-[ClashDisplay-Regular]'>{t("events.description_cattolica")}</p>
                    </div>
                    
                </div>

                <div className="gap-6 sm:gap-12 mt-8 sm:mt-20 flex md:flex-row flex-col w-full text-white text-left ml-auto mr-auto md:ml-[150px]">
                    <div className="mt-8 text-center md:text-left w-full md:w-5/12 bg-gradient-to-l md:pl-6 sm:pb-16 md:px-10 rounded-xl">
                    <h2 className="font-[ClashDisplay-Semibold] text-[28px] md:text-[40px]/10 titleBlueLine mt-4 mb-4 sm:mb-8">
                    {t("events.title_misano")}
                    </h2>
                        <p className='sm:mt-10 font-[ClashDisplay-Regular]'>{t("events.description_misano")}</p>
                    </div>
                ...
                <div className="gap-6 sm:gap-12 mt-8 sm:mt-20 flex md:flex-row flex-col w-full text-white text-left ml-auto mr-auto md:ml-[170px]">
                ...
                <div className='w-full h-full relative bg-[#000000]/20'>
                    ...
                    <div className="mt-8 text-center order-1 md:order-2 md:text-left w-full md:w-5/12 bg-gradient-to-l md:pl-6 sm:pb-16 md:px-10 rounded-xl">
                    <h2 className="font-[ClashDisplay-Semibold] text-[28px] md:text-[40px]/10 titleBlueLine mb-4 sm:mb-8">
                    {t("events.title_indoor_events")}
                    </h2>
                        <p className='sm:mt-10 font-[ClashDisplay-Regular]'>{t("events.description_indoor")}</p>
                    </div>
                ...
                <h2 className="ml-auto mr-auto font-[ClashDisplay-Semibold] text-[32px] mb-2 sm:mb-6 md:mb-4 md:text-[40px] w-fit titleBlueLineLeft">
                    {t("events.in_2024")}
                    </h2>
                    <p className="text-white font-[ClashDisplay-Regular]">{t("events.description_2024")}</p>
                    </div>

                    <div className="flex gap-5 sm:gap-10 md:gap-5 flex-wrap ml-auto me-auto items-center justify-center w-full md:w-2/3 mt-8 sm:mt-16">
        ...
        <div className="w-full py-10 bg-[#070707] mt-0 sm:mt-20">
