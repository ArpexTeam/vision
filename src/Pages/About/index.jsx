...
function About() {
  ...
  return (
    <div className='bg-black w-full py-5 sm:py-20 md:py-0 h-auto relative'>
      <div className='max-w-[1280px] w-4/5 mx-auto h-auto relative'>
        ...
        <div className="w-full gap-8 md:pt-20">
          <div className="text-white w-full md:w-9/12 mx-auto text-center">
            <h1 className="font-[ClashDisplay-Bold] text-[36px] md:text-[42px] mb-3 sm:mb-8">{t("who_are.title_who")}</h1>
        ...
        <div className='mt-7 sm:mt-20'>
          <h2 className='font-[ClashDisplay-Semibold] text-[32px] md:text-[42px]'>{t("who_are.title_strategic")}</h2>
          <div className='flex flex-col lg:flex-row gap-4 sm:gap-10 mt-6 sm:mt-20 relative textCardTeam'>

            {/* Card: ILARIA */}
            <div className='order-2 lg:order-1 flex flex-col items-center lg:mb-0 mb-0 sm:mb-20'>
              <div className='flex w-3/4 justify-center md:w-2/4 lg:w-full lg:h-[500px] cardFront relative'>
                <div className="h-[200px] sm:h-[400px] mt-auto relative">
            ...
            {/* Card: PEDRO */}
            <div className='order-1 lg:order-2 w-fit flex flex-col items-center lg:mb-0 sm:mb-20'>
              <div className='sm:w-3/4 md:w-2/4 lg:w-full h-[200px] sm:h-[500px] cardFront'>
            ...
            {/* Card: DANIEL */}
            <div className='order-3 lg:order-3 w-fit flex flex-col items-center lg:mb-0 sm:mb-20'>
      ...
      <div className="w-8/12 mx-auto">
        <h2 className='font-[ClashDisplay-Light] text-white text-[20px] md:text-[22px] sm:mt-20 sm:mb-20'>
        {t("who_are.description_text")}
        </h2>
      </div>

      {/* Seção de contato */}
      <div className="w-full py-7 sm:py-10 bg-[#070707] mt-0 sm:mt-20">
        <div className="max-w-[1280px] mx-auto flex justify-center text-center w-4/5 flex-col items-center">
          ...
          <button
            className="mt-4 sm:mt-10 bg-[#06E7F2] h-fit w-fit p-3 px-14 rounded-xl font-[ClashDisplay-Semibold] hover:bg-transparent hover:text-[#06E7F2]"
