    ...
    <div className="bg-black w-full pt-28 h-auto relative">
      ...
      <div className="text-left flex justify-between mb-40">
        ...
        <h1 className="font-[ClashDisplay-Light] text-[17px]">
          ...
          <div className="w-1/3">
            <div className="ml-auto w-10/12 h-full rounded-2xl">
                <img src={ImageService} alt="Image-service" className='w-60 h-56' />
            </div>
          </div>
      </div>

      <svg style={{ transform: "translateY(-110px)" }} className='float-left' width="87" height="3460" viewBox="0 -100 87 4500" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
          <div className="pb-2 mt-20">
            ...
            <CardService image={cardImg3} title={"CGI 3D"}
             textBody={"With the power of CGI, we insert 3D elements into real scenes, creating a perfect fusion between the virtual and the real."}
            ...
            <CardService image={cardImg5} title={"3D Animation"}
             textBody={"We animate any 3D object or scene, bringing movement and life to every detail."} paddingDirection={"pl-10 pr-16"} top="mt-[200px]"
              left="" marginDirection="-ml-48 md:-ml-20 -mb-28" flexDirection="flex-row" gradientDirection="bg-gradient-to-l" />
          ...
          <CardService image={cardImg7} title={"Website creation and editing"}
             textBody={ <span className='break-words'>We design and edit websites that combine functionality and creativity to enhance your online presence and engage your audience.</span>}
              paddingDirection={"pl-10 pr-16"} top="mt-[200px]" left="" marginDirection="-ml-48 md:-ml-20 -mb-40" flexDirection="flex-row" gradientDirection="bg-gradient-to-l" />
            
            <div className="relative w-full text-left mt-72">
              <h1 className="font-[ClashDisplay-Bold] text-[28px] mb-7 -mt-5">Our Numbers in 2024</h1>
