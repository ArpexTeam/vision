...
function Commercial(){
    return(
        <div className='bg-black w-full pt-20 h-auto relative'>
            ...
            <div>
                <img src={commercial} className='w-7/12 ml-auto'/>
            </div>
            </div>
            ...
            <div className='flex gap-6 justify-between flex-wrap mt-24'>
            ...
            <div className='flex gap-10 justify-between flex-wrap mt-24'>
