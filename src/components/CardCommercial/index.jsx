...
function CardCommercial(props){
    ...
    return(
        ...
        <div className={`${props.type == 'large' ? 'h-56 w-10/12 sm:w-[45%] md:w-[31%]' : 'h-[350px] w-10/12 sm:w-[45%] md:w-[30%] lg:w-[25%]'} bg-gray-700 mt-6`} style={{backgroundImage:`url(${props.thumb})`, backgroundSize:'cover', backgroundPosition:'center'}}>
