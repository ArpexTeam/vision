...
function CardCommercial(props){
    ...
    return(
        ...
        <div className={`${props.type == 'large' ? 'h-56 w-[31%]' : 'h-[350px] w-[30%]'} bg-gray-700 mt-6`} style={{backgroundImage:`url(${props.thumb})`, backgroundSize:'cover', backgroundPosition:'center'}}>
