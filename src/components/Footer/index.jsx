        ...
        <div className="bg-[#0C0C0C]">
            ...
            <div className='text-center sm:text-left w-full sm:w-5/12 lg:w-auto'>
                ...
                <ul className='flex flex-col gap-2 mt-6 '>
                    <li><NavLink to='/servicos' className={'hover:text-[#06E5F180] cursor-pointer'}>{t("services.video_production")}</NavLink></li>
                    <li><NavLink to='/servicos' className={'hover:text-[#06E5F180] cursor-pointer'}>{t("services.motion_design")}</NavLink></li>
                    <li><NavLink to='/servicos' className={'hover:text-[#06E5F180] cursor-pointer'}>{t('services.cgi_3d')}</NavLink></li>
                    <li><NavLink to='/servicos' className={'hover:text-[#06E5F180] cursor-pointer'}>{t("services.3d_modeling")}</NavLink></li>
                    <li><NavLink to='/servicos' className={'hover:text-[#06E5F180] cursor-pointer'}>{t("services.3d_animation")}</NavLink></li>
